 ...
 *
 * ⚠️ **여기서는 구독을 팔지 않는다.** 레퍼런스 최상단의 구독 CTA 자리에는 대신
 * **수료증 안내**를 둔다 — 이 사이트가 파는 것은 강의 **단건**이다.
 * (2026-08-08 어도비가 생기면서 "구독은 만들지 않는다"는 옛 **전역** 규칙 자체는
 *  폐기됐지만, 그것이 슬로우캠퍼스도 정기 결제로 바꿔야 한다는 뜻은 아니다 —
 *  강의는 **들은 횟수가 수료증이 되는** 구조라 "매달 내는 것"과 성격이 맞지 않는다.)
 *
